...
class DeleteUserCallbackGet200Response(BaseModel):
    """
    DeleteUserCallbackGet200Response
    """ # noqa: E501
    success: StrictBool = Field(description="Indicates if the deletion was successful")
    ...
    def message_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['User deleted']):
            raise ValueError("must be one of enum values ('User deleted')")
        return value
