...
class GeneratePasskeyRegistrationOptions200ResponseAuthenticatorSelection(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["authenticatorAttachment", "requireResidentKey", "userVerification"]
