...
class OneTapCallbackPostRequest(BaseModel):
    """
    OneTapCallbackPostRequest
    """ # noqa: E501
    id_token: StrictStr = Field(description="Google ID token, which the client obtains from the One Tap API", alias="idToken")
