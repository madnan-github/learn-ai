...
class SendVerificationEmail200Response(BaseModel):
    """
    SendVerificationEmail200Response
    """ # noqa: E501
    status: Optional[StrictBool] = Field(default=None, description="Indicates if the email was sent successfully")
