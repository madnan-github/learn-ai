...
class SignUpWithEmailAndPassword200Response(BaseModel):
    """
    SignUpWithEmailAndPassword200Response
    """ # noqa: E501
    token: Optional[StrictStr] = Field(default=None, description="Authentication token for the session")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "token": obj.get("token"),
            "user": SignUpWithEmailAndPassword200ResponseUser.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
