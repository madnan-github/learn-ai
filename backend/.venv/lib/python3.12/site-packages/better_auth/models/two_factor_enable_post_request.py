...
class TwoFactorEnablePostRequest(BaseModel):
    """
    TwoFactorEnablePostRequest
    """ # noqa: E501
    password: StrictStr = Field(description="User password")
    issuer: Optional[StrictStr] = Field(default=None, description="Custom issuer for the TOTP URI")
    __properties: ClassVar[List[str]] = ["password", "issuer"]
