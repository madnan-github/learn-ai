...
class TwoFactorGenerateBackupCodesPost200Response(BaseModel):
    """
    TwoFactorGenerateBackupCodesPost200Response
    """ # noqa: E501
    status: StrictBool = Field(description="Indicates if the backup codes were generated successfully")
    backup_codes: List[StrictStr] = Field(description="Array of generated backup codes in plain text", alias="backupCodes")
    __properties: ClassVar[List[str]] = ["status", "backupCodes"]
