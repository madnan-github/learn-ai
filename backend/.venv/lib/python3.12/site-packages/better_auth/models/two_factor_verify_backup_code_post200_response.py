...
class TwoFactorVerifyBackupCodePost200Response(BaseModel):
    """
    TwoFactorVerifyBackupCodePost200Response
    """ # noqa: E501
    user: TwoFactorVerifyBackupCodePost200ResponseUser
    session: TwoFactorVerifyBackupCodePost200ResponseSession
    __properties: ClassVar[List[str]] = ["user", "session"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user": TwoFactorVerifyBackupCodePost200ResponseUser.from_dict(obj["user"]) if obj.get("user") is not None else None,
            "session": TwoFactorVerifyBackupCodePost200ResponseSession.from_dict(obj["session"]) if obj.get("session") is not None else None
        })
        return _obj
