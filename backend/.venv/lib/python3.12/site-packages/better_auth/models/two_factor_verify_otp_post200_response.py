...
class TwoFactorVerifyOtpPost200Response(BaseModel):
    """
    TwoFactorVerifyOtpPost200Response
    """ # noqa: E501
    token: StrictStr = Field(description="Session token for the authenticated session")
    user: TwoFactorVerifyOtpPost200ResponseUser
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "token": obj.get("token"),
            "user": TwoFactorVerifyOtpPost200ResponseUser.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
